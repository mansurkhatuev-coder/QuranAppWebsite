...
(function (global) {
  const RULES = [
    { id: 'hamza', title: 'ХӀамза', page: 9 },
    { id: 'istila', title: 'Буквы истиӀаъ', page: 11 },
    { id: 'article', title: 'Артикль', page: 38 },
    { id: 'madd_article', title: 'Мадд перед артиклем', page: 40 },
    { id: 'lam_allah', title: 'Льам в اللّٰه / اللّٰهُمَّ', page: 48 },
