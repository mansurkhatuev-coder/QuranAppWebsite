...
(function (global) {
  ...
  const COURSE_META = {
    ...
    tajweed: { label: 'Таджвид', hint: 'Тухфа и Муаллим — один курс' },
    madina: { label: 'Мединский арабский', hint: 'Уроки по порядку с 1-го' },
    names99: { label: 'Имена Аллаха', hint: '99 имён · блоки 1:10 … 91:99' },
