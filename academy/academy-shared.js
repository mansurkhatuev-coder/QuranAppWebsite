...
(function (global) {
  ...
  const ERROR_MAP = {
    ...
    open_mode: 'В открытом уроке этой кнопки нет — ученики идут сами.',
    ...
    not_finished: 'Итоги будут доступны после завершения урока.',
    create_failed: 'Не удалось создать занятие. Попробуйте ещё раз.',
    ...
    hub_not_found: 'Набор уроков не найден. Проверьте ссылку.',
